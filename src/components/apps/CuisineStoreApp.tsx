    ...
    options: [
      {
        ...
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v4/peanut-bacon.png",
        imageAlt: "Happy Bag sabor cacahuate con tocino",
      },
      {
        label: "Pollo con zanahoria · 100 g",
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v4/chicken-carrot.png",
        imageAlt: "Happy Bag sabor pollo con zanahoria",
      },
      {
        label: "Pollo con calabaza · 100 g",
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v4/chicken-pumpkin.png",
        imageAlt: "Happy Bag sabor pollo con calabaza",
      },
      {
        label: "Manzana con plátano · 100 g",
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v4/apple-banana.png",
