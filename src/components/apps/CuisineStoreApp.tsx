    ...
    options: [
      {
        ...
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v2/peanut-bacon.webp",
        imageAlt: "Happy Bag sabor cacahuate con tocino",
      },
      {
        label: "Pollo con zanahoria · 100 g",
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v2/chicken-carrot.webp",
        imageAlt: "Happy Bag sabor pollo con zanahoria",
      },
      {
        label: "Pollo con calabaza · 100 g",
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v2/chicken-pumpkin.webp",
        imageAlt: "Happy Bag sabor pollo con calabaza",
      },
      {
        label: "Manzana con plátano · 100 g",
        price: 85,
        image: "/cuisine/products/happy-bag-flavors-v2/apple-banana.webp",
